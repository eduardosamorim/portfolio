class Strings {
  ...
  static final tech2 = ''' PHP'''; // space for manual padding
  static final tech3 = ''' PostgreSQL'''; // space for manual padding
...
//     '''Experienced many technologies such as wifi (TCP/UDP), BLE, MQTT, LIVE DATA, Google ML - Tensor Flow, GraphQL and so on.''';
  ...
  static final expCompName3 = '''Actuary''';
  static final expDesig3 = '''Junior Software Engineer''';
  static final expDur3 = '''Oct 2022 - Present''';
  static final expAbout3 =
      '''A Brazilian company focused on Social Security, with numerous clients across Brazil, including large municipalities, serving various users.''';
  static final expAbout3_2 =
      '''I work with a team of 3 senior developers, always with thorough analysis and requirements.''';
  static final expAbout3_3 =
      '''Always striving for the best possible code for each maintenance, considering future improvements, etc.''';
